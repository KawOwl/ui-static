...
if(-1===k)s+=v
else s=s.substring(0,k)+v+s.substring(k)
s=c(s)}return f["[[locale]]"]=s,f}function d(e,t){for(var n=t.length,a=new r,i=0;i<n;){var o=t[i]
...
void 0===E&&void 0===L||(L=y(s,"maximumSignificantDigits",E=y(s,"minimumSignificantDigits",1,21,1),21,21),l["[[minimumSignificantDigits]]"]=E,l["[[maximumSignificantDigits]]"]=L)
...
for(var f=n-t;f>0&&"0"===s.slice(-1);)s=s.slice(0,-1),f--;("."===s.slice(-1)&&(s=s.slice(0,-1)),c<r)&&(s=ae.call(Array(r-c+1),"0")+s)
