...
if(-1===k)o+=f
else o=o.substring(0,k)+f+o.substring(k)
o=C(o)}return u["[[locale]]"]=o,u}function Y(e,r){for(var t=r.length,n=new D,a=0;a<t;){var i=r[a]
...
s=g+"."+s.substring(u-i,s.length),c=g.length}else c=s.length
for(var f=n-t;f>0&&"0"===s.slice(-1);)s=s.slice(0,-1),f--;("."===s.slice(-1)&&(s=s.slice(0,-1)),c<r)&&(s=y.call(Array(r-c+1),"0")+s)
